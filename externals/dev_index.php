...
<div style="float:left; clear:both; padding: 0.5cm 3.0cm 1.0cm 3.0cm; text-align: center; width:100%; margin:0px auto;">
  <h1 style="padding: 0.0cm 1.0cm 1.0cm 1.0cm;"><b>Awesome Projects using ATLAS Open Data</b></h1>
  <!-- Place this tag where you want the Awesome Table Widget to render -->
  <div data-type="AwesomeTableView" data-viewID="-KR9TYH186ScrMSZIoMa"></div>
</div>


<div style="float:left; clear:both; padding: 0.5cm 0.5cm 2.5cm 0.5cm; text-align: center; width:100%; margin:0px auto;">
  <h1>also <b>Explore</b></h1>
