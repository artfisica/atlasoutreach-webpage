    ...
    <table width="100%" border="0">
      <tr>
        <td style="width:50%; text-align: left; padding: 1.5cm 1.5cm 1.5cm 1.5cm;">
          <h1 style="font-family:verdana; font-size:260%;"><b>Datasets Repository</b></h1>
        </br>
        <p style="font-family:verdana; font-size:120%;">
          <b>
            Here you have in a single place all the necessary samples in order to start you physics analysis in a more complete way.
        ...
        <ul style="font-family:verdana; font-size:110%; padding: 0.5cm 1.0cm 1.0cm 1.0cm;">
          <li>Any of the MonteCarlo samples</li>
          <li>One or both Data samples</li>
          <li>A comple zip file with all the datests for a complete analysis!</li>
        </ul>
      </p>
    </td>

    <td style="width:50%; padding: 0.1cm 0.2cm;">
      <img src="../DataAndTools/pictures/ATLAS_imagine_initial_page_1.png" alt="Repository" style="width:100%">
    </td>
  </tr>
</table>
</div>
      ...
      <div id="zip" class="tab-pane fade">
        <CENTER>
          ...
          <table style="width:100%" >
            ...
            <tr>
              <td><a href="https://root.cern.ch/doc/master/classTFile.html"> <img src="/atlas-opendata/DataAndTools/pictures/ROOT_icon_small.png" alt="root icon" style="width:40px;height:40px;border:0;"></a></td>
              <td><a href="../release/samples/complete_set_of_ATLAS_open_data_samples_June_2016.zip">complete_set_of_ATLAS_open_data_samples_June_2016.zip</a></td>
              <td>06-May-2016 10:00</td>
              <td>5.7Gb</td>
            </tr>
            <tr>
