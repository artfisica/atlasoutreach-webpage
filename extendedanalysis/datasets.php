...
<body>
  <div style="float:left; clear:both; padding: 2.0cm 2.0cm 1.0cm 2.0cm; text-align: left; width:100%; margin:0px auto;">
    <h1>Level 3: <b>Data & Tools Repository - Datasets!</b></h1>
    <p>Here it is! below you can get the official samples released to the public.
      You can download a single ROOT file or the complete collection in a single zip file.
      Check the tabs and start your search.
      Don't forget to grab the softaware or the VMs that better fit your objetives</p>
    </div>
