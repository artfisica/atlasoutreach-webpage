...
<body>
  <div style="float:left; clear:both; padding: 0.0cm 0.0cm 0.0cm 0.0cm; text-align: left; width:100%; margin:0px auto;">
    <CENTER>
      <h1 style="font-family:verdana; font-size:260%;"><b>Data & Tools</b> - Virtual Machines</h1>
    </CENTER>
  </div>
      ...
      <tr>
        <td style="width:47%; padding: 0cm 0% 0.4cm 5%;">
          <p style="font-family:verdana; text-align: left;">
            Download a Virtual Machine, which includes useful software, samples and tools for your analysis.
  ...
  <div style="width:100%; padding: 0.4cm 5% 2.5cm 5%; clear:both; text-align:left; float:left; margin:0px auto;">
    <div class="container">
      ...
      <ul class="nav nav-tabs">
        ...
        <li>               <a data-toggle="tab" href="#menu1">VM Version <b>S+</b></a></li>
        <li>               <a data-toggle="tab" href="#menu2">VM Version <b>M</b></a></li>
        <li>               <a data-toggle="tab" href="#menu3">VM Version <b>L</b></a></li>
        <li>               <a data-toggle="tab" href="#menu4">VM Version <b>N</b></a></li>
        <li>               <a data-toggle="tab" href="#menu5">VM Version <b>&mu;</b></a></li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div id="menu2" class="tab-pane fade">
          ...
          <p style="width:50%; text-align: left; padding: 2.0cm 10% 0.5cm 10%"><b>Description:</b> VM-M for "<i>medium</i>", it has a compressed size of ~4.6GB, and a uncompressed size of ~11GB. This contains a complete Scientific Linux OS 6.7, important software dependencies and the version of ROOT v6-07-06.</p>
        </div>
        ...
        <div id="menu5" class="tab-pane fade">
          ...
          <p style="width:50%; text-align: left; padding: 2.0cm 10% 0.5cm 10%"><b>Description:</b> VM-&mu; for "<i>micro</i>" with unknown sizes yet, but much smaller that VM-N or VM-S. It will contain a Linux distribution with not graphical user interface. It will have important software dependencies and the version of ROOT v6*</p>
        </div>
      </div>
    </div>
  </div>
