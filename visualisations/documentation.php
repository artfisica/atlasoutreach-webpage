...
<body>
  <div style="float:left; clear:both; padding: 0.0cm 0.0cm 0.0cm 0.0cm; text-align: left; width:100%; margin:0px auto;">
    <CENTER>
      <h1 style="font-family:verdana; font-size:260%;"><b>Get Started</b> - Documentation</h1>
    </CENTER>
        ...
        <tr>
          <td style="width:50%; padding: 0.5cm 0% 0.3cm 0%; border: 2px solid black;">
            ...
            <div class="hovereffect">
              ...
              <a href="http://opendata.atlas.cern/books/current/get-started/_book/" target="_blank"><img class="img-responsive" src="../DataAndTools/pictures/gitbook_view.png" alt="ATLAS to GitBook" style="width:80%"></a>
              <CENTER>
            </div>
          </td>
<!--
