      ...
      <tr>
        <td style="width:50%; text-align: left; padding: 1.5cm 1.5cm 1.5cm 1.5cm;"> <!-- style="border: 1px solid black; background-color: #0b80c3;"> -->
          ...
          <p style="font-family:verdana; font-size:120%;">
            <b>
              at <a href="http://home.cern/">CERN</a> in Geneva has released the world’s first open release of 8 TeV data. This data was gathered from proton collisions in the Large Hadron Collider (LHC) in 2012. <a href="./index.php">ATLASOpenData</a> guides you through how to use and download the data, how to visualise your results and even provides open-source software for you to make your own discoveries
            </br>
          </b>
        </br>
        Learn how to:
...
<div style="float:left; clear:both; padding: 0.0cm 0.0cm 0.0cm 0.0cm; text-align: center; width:100%; margin:0px auto; border:none!important; background-color:white;">
  <table width="100%" border="0">
    <tr>
      <td style="width:50%; padding: 4cm 1% 4cm 20%;">
