...
<body>
  <div style="float:left; clear:both; padding: 1.0cm 12% 1.0cm 12%; text-align: left; width:100%; margin:0px auto;">
    <!-- <h1 style="font-family:verdana; font-size:200%;">Access <b>open data</b> from the <b><a href="http://atlas.cern/" title="ATLAS public site" target="_blank">ATLAS</a> Experiment</b> at <a href="http://home.cern/" target="_blank">CERN</a></h1> -->
    <h1 style="font-family:verdana; font-size:200%;"><b>Access open data from the ATLAS Experiment at CERN</b></h1>
    <p  style="font-family:verdana; font-size:110%;">The ATLAS data from 100 trillion proton collisions is now public! This marks the world’s first open release of 8 TeV data, gathered from the <a href="https://home.cern/topics/large-hadron-collider" target="_blank">Large Hadron Collider</a> in 2012.</p>
    <p  style="font-family:verdana; font-size:110%;"><b><a href="./index.php">ATLAS open data</a></b> guides you through how to visualise the data, how to download and use the data, and even provides open-source software for you to make your own discoveries. <b>Get started now!</b></p>
  </div>
  ...
  <div style="float:left; clear:both; padding: 0.0cm 0.0cm 0.0cm 0.0cm; text-align: center; width:100%; margin:0px auto; border:none!important; background-color:white;">
    <table width="100%" border="0">
      <tr>
        <td style="width:50%; padding: 2cm 1% 2cm 20%;">
          <div class="hovereffect">
            <img class="img-responsive" src="/atlas-opendata/DataAndTools/pictures/handmade_toolbox.png" alt="Analysis ToolBox" style="width:100%">
          </div>
        </td>
        <td style="width:50%; text-align: left; padding: 2cm 20% 2cm 1%">
